<template>
  <div id="bg">
    ...
    <div class="mypage-body col-sm-8 col-md-5 p-0">
      ...
      <div class="d-flex justify-content-center align-items-center m-4">
        ...
        <div class="pt-5" style="position: relative">
          ...
          >
            <img
              src="@/assets/flaticon/pencil.png"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div>
              ...
              />
              <div
                v-if="error.changePasswordConfirm"
                style="
                  text-align: left;
                  color: red;
                  font-size: 12px;
    ...
    <img
      ...
      style="width: 15%; position: absolute; right: 23rem; bottom: 3.2rem"
      alt=""
    />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    checkForm() {
      if (
        !this.passwordSchema.validate(this.currentPassword) ||
      ...
      if (
        !this.passwordSchema.validate(this.changePassword) ||
        this.changePassword.length < 8
      ) {
    ...
    async pictureUpload() {
      await awss3
        .updatePhoto("profileImg", this.$store.state.user.profileImg, "photo")
        .then((res) => {
          let accessToken = sessionStorage.getItem("access-token");
          let refreshToken = sessionStorage.getItem("refresh-token");
