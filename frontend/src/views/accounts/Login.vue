  ...
  <div id="bg">
    <div class="inner-header flex flex-column">
      ...
      <div>
        ...
        <br />
        <img
          src="@/assets/icontact/light_log.png"
          style="width: 20rem; margin: 1.5rem"
          alt="logo-image"
        />
        <br />
      </div>
      ...
      <hr />
      <div>
        <button class="etcBtn" @click="$router.push({ name: 'Signup' })">
          회원가입
        </button>
        |
        <button
          class="etcBtn"
          @click="$router.push({ name: 'ChangePasswordAuth' })"
        >
          비밀번호 찾기
        </button>
      </div>
      ...
      try {
        ...
        if (result.accept === 2) {
          ...
          this.$fire({
            ...
            <p style="font-size: 0.95rem;; font-family: 'NanumSquareRound';">관리자에게 문의하세요.</p>`,
            type: "error",
            focusConfirm: false,
        ...
        this.$fire({
          html: `<a href="javascript:void(0);"></a><p style="font-size: 0.95rem; font-family: 'NanumSquareRound';">아이디와 비밀번호를 확인하세요.</p>`,
          type: "error",
          confirmButtonColor: "#58679A",
          focusConfirm: false,
        });
